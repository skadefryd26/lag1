# Skadefryd participant profile

<!-- This local file is intentionally ignored by Git. -->
...
- For a developer: discuss implementation trade-offs when useful; only create branches, commits, pushes, or pull requests when asked.
